  ...
  const agroAlerts = [
    {
      type: "Pest Outbreak",
      location: "Kollam",
      description: "Locust swarm reported",
      icon: <Activity className="h-4 w-4 text-red-600" />,
    },
    {
      type: "Cattle Disease",
      location: "Kottayam",
      description: "Foot and Mouth Disease alert",
      icon: <ShieldAlert className="h-4 w-4 text-yellow-600" />,
    },
    {
      type: "Pest Outbreak",
      location: "Alappuzha",
      description: "Fall Armyworm detected",
      icon: <Activity className="h-4 w-4 text-red-600" />,
    },
  ];
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {agroAlerts.map((alert, idx) => (
            <div
              key={idx}
              className="flex items-center justify-between p-3 bg-red-50 rounded-lg shadow-sm hover:shadow-md transition"
            >
                  ...
                  <div>
                    ...
                    <div className="w-full bg-blue-100 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${(
                            pestPrediction.risk_probability * 100
                          ).toFixed(2)}%`,
                        }}
                      ></div>
                    </div>

...
export function DataAnalytics() {
  ...
  function IndicesReport() {
    ...
    useEffect(() => {
      fetch("http://localhost:8000/field/awd-data") // adjust endpoint
        .then((res) => res.json())
    ...
    const awd_detected = data?.awd_detected ?? true;
    const cycles_count = data?.cycles_count ?? 3;
    const dry_days_detected = data?.dry_days_detected ?? 5;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        ...
        <div className="p-4 bg-blue-50 rounded-lg flex flex-col items-center justify-center shadow-sm hover:shadow-md transition">
          ...
          <p className="text-xl font-bold text-blue-700">{cycles_count} cycles</p>
        </div>
        ...
        <div className="p-4 bg-yellow-50 rounded-lg flex flex-col items-center justify-center shadow-sm hover:shadow-md transition">
          ...
          <p className="text-xl font-bold text-yellow-700">{dry_days_detected} days</p>
        </div>
      </div>
    </div>
  </CardContent>
